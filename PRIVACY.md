...
It must not contain credentials, tokens, contact details, government identifiers, exact addresses, financial account data, health data, private customer information, or unrelated personal details.

The learner can ask to view, correct, export, or delete the profile at any time. The Skill must not publish or transmit it without separate explicit authorization.
